  ...
  <div class="main-login list-receipt-page">
    <div>
      <div class="login login-width login-mobile">
        <el-page-header content="Báo cáo đã gửi" @back="goBack">
        </el-page-header>
                  ...
                  <div class="">
                    <div class="d-flex justify-between " style="flex-wrap: wrap;">
                      ...
                      <div class="  items-center">
                        <el-tag effect="dark" v-if="item.reportStatus === 1" type="success">Đồng ý</el-tag>
                        <el-tag effect="dark" v-else-if="item.reportStatus === 2" type="danger">Từ chối</el-tag>
                        <el-tag effect="dark" v-else type="warning">Đang chờ</el-tag>
                      </div>
                    </div>
...
export default {
  ...
  methods: {
    ...
    async getListEvent() {
      ...
      try {
        const response = await this.$store.dispatch(REPORT_GET_LIST_HISTORY, this.id)
